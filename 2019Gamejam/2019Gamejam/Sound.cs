...
namespace _2019Gamejam
{
    class Sound
    {
        ...
        /// </summary>
        /// <param name="name">アセット名</param>
        public void CreateSEInstace(string name)
        {
            //既に登録されていたら何もしない
        ...
        /// <param name="loopFlag">loopFlag</param>
        public void PlaySEInstances(string name, int no, bool loopFlag =
            false)
        {
            Debug.Assert(
